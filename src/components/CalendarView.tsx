...
export function CalendarView() {
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-xl flex flex-col w-full">
      ...
      <div className="hidden xl:grid grid-cols-7 gap-2 text-center font-semibold text-gray-600 pb-2 mb-2">
      ...
      <div className="hidden xl:grid grid-cols-7 gap-2 flex-grow">
