...
def run(playwright):
    ...
    try:
        ...
        page.screenshot(path="jules-scratch/verification/meal_card_style_fix.png")
        print("Meal card screenshot taken.")

        # Calendar Image Screenshot
        print("Navigating to calendar...")
        page.goto("http://localhost:3000/")
        page.wait_for_load_state("load")
        time.sleep(1)
        page.screenshot(path="jules-scratch/verification/calendar_image_style_fix.png")
        print("Calendar image screenshot taken.")

    except Exception as e:
        print(f"An error occurred: {e}")
        page.screenshot(path="jules-scratch/verification/error_v4.png")
